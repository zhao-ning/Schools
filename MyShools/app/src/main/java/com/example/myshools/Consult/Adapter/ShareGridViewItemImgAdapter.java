...
public class ShareGridViewItemImgAdapter extends BaseAdapter {
    private ArrayList<String> dataSource;//数据源
    private int itemResId; //布局
    private Context context;//上下文环境
    public ShareGridViewItemImgAdapter(Context context, ArrayList<String> list, int itemResId) {
